...
//!
//! These types support the feedback collection system for Ccode sessions.
//! The agent (ccode-shell) uses heuristics to determine when to request feedback,
...
fn default_tier1_prompt() -> String {
    "You've been using Ccode productively! Would you mind sharing quick feedback?".to_string()
}
