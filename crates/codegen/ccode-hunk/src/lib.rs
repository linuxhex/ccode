//! ccode-hunk - Track file hunks (diffs) with agent/external attribution.
//!
//! This crate provides:
//! - Actor-based hunk tracking with source attribution (Agent vs External)
//! - Integration with ccode-shell sessions
//!
//! ## Actor Pattern
//!
...
//!
//! ```rust,ignore
//! use ccode_hunk::{HunkTrackerActor, HunkEvent, TrackingMode, HunkAction};
//! use tokio::sync::mpsc;
//!
