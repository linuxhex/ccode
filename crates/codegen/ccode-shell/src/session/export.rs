...
/// JSON-RPC wrapper for ccode extension notifications.
#[derive(Debug, Serialize)]
...
const CCODE_SESSION_UPDATE_METHOD: &str = "_ccode.dev/session/update";
        ...
        updates
            ...
            .map(|update| match update {
                ...
                SessionUpdate::Ccode(notification) => {
                    ExportedMessage::from_ccode_notification(notification)
                }
            })
            .collect()
    }
