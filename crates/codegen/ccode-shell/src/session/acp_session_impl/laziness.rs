...
impl SessionActor {
    ...
    /// sees "Ccode is thinking", streaming token chunks, or any other
    ...
    pub(crate) async fn maybe_fire_laziness_check(self: Arc<Self>) {
        ...
        let items = vec![
            ConversationItem::System(ccode_sampling_types::SystemItem {
        ...
        let request = ConversationRequest {
            ...
            // Don't pass `reasoning_effort` — `ccode-4.5` (and
            // other tool-flavoured Ccode variants) reject the field at
            ...
            x_ccode_session_id: Some(session_id_str),
