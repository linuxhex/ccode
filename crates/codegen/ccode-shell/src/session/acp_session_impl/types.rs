...
pub(crate) enum SamplerTurnOutcome {
    ...
    Response(
        ...
        Box<ccode_sampler::InferenceLatencyStats>,
    ),
    CompactAndResubmit,
...
pub(crate) enum DrainSource {
    Pending(ccode_tools::implementations::ccode_build::update_goal::UpdateGoalInput),
    Channel(ccode_tools::implementations::ccode_build::update_goal::UpdateGoalEnvelope),
}
