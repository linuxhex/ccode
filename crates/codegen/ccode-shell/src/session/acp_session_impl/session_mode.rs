...
impl SessionActor {
        ...
        *self.current_prompt_mode.lock() = prompt_mode;
        ...
        if mode.is_plan() {
            ...
            ccode_telemetry::session_ctx::log_event(
                ccode_telemetry::events::PlanModeToggled {
                    enabled: true,
                    trigger: ccode_telemetry::events::PlanModeTrigger::User,
                    turn_in_flight,
    ...
    /// first-entry/reentry distinction), or ccode's reentry/full variant.
