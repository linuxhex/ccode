...
use ccode_tools::types::tool_index::{
...
mod tests {
    ...
    fn search_underscore_joined_identifier_components() {
        let tools = vec![
            ToolMetadata {
                qualified_name: "ccode_com_chronosphere__query_prometheus_range".into(),
                server_name: "ccode_com_chronosphere".into(),
            ...
            ToolMetadata {
                qualified_name: "ccode_com_chronosphere__list_metrics".into(),
                server_name: "ccode_com_chronosphere".into(),
        ...
        let names: Vec<&str> = snap.results.iter().map(|r| r.tool_name.as_str()).collect();
        assert!(names.contains(&"ccode_com_chronosphere__query_prometheus_range"));
        assert!(names.contains(&"ccode_com_chronosphere__list_metrics"));
        ...
        assert_eq!(
            ...
            "ccode_com_chronosphere__query_prometheus_range"
        );
    }
    ...
    fn split_mixed_formats() {
        assert_eq!(
            split_identifier("ccode_com_slack__slack_send_message"),
            vec!["ccode", "com", "slack", "slack", "send", "message"]
        );
    }
    ...
    fn mcp_format_tools() -> Vec<ToolMetadata> {
        vec![
            ...
            ToolMetadata {
                qualified_name: "ccode_com_slack__slack_send_message".into(),
                server_name: "ccode_com_slack".into(),
            ...
            ToolMetadata {
                qualified_name: "ccode_com_chronosphere__QueryPrometheusRange".into(),
                server_name: "ccode_com_chronosphere".into(),
    ...
    fn fmt_exact_snake_server_snake_tool() {
        ...
        let index = Bm25ToolSearchIndex::new(make_snapshot(mcp_format_tools()));
        let snap = index.search_snapshot("ccode_com_slack__slack_send_message", 5);
        assert_eq!(snap.results.len(), 1);
        assert_eq!(
            snap.results[0].tool_name,
            "ccode_com_slack__slack_send_message"
        );
    }
    ...
    fn fmt_exact_snake_server_pascal_tool() {
        ...
        let index = Bm25ToolSearchIndex::new(make_snapshot(mcp_format_tools()));
        let snap = index.search_snapshot("ccode_com_chronosphere__QueryPrometheusRange", 5);
        assert_eq!(snap.results.len(), 1);
        assert_eq!(
            snap.results[0].tool_name,
            "ccode_com_chronosphere__QueryPrometheusRange"
        );
    }
    ...
    fn fmt_snake_server_only_falls_through() {
        let index = Bm25ToolSearchIndex::new(make_snapshot(mcp_format_tools()));
        let snap = index.search_snapshot("ccode_com_slack", 5);
        for r in &snap.results {
            assert_ne!(
                r.tool_name, "ccode_com_slack",
                "should not match a bare server name as a tool"
            );
        }
    }
    ...
    fn production_haystack() -> Vec<ToolMetadata> {
        ...
        vec![
            // ── ccode_com_slack (17 tools) ───────────────────────────
            tool(
                "ccode_com_slack__slack_create_canvas",
                "ccode_com_slack",
                "slack_create_canvas",
            ...
            tool(
                "ccode_com_slack__slack_get_reactions",
                "ccode_com_slack",
                "slack_get_reactions",
            ...
            tool(
                "ccode_com_slack__slack_list_channel_members",
                "ccode_com_slack",
            ...
            tool(
                "ccode_com_slack__slack_read_canvas",
                "ccode_com_slack",
                "slack_read_canvas",
            ...
            tool(
                "ccode_com_slack__slack_read_channel",
                "ccode_com_slack",
                "slack_read_channel",
            ...
            tool(
                "ccode_com_slack__slack_read_file",
                "ccode_com_slack",
                "slack_read_file",
            ...
            tool(
                "ccode_com_slack__slack_read_thread",
                "ccode_com_slack",
                "slack_read_thread",
            ...
            tool(
                "ccode_com_slack__slack_read_user_profile",
                "ccode_com_slack",
            ...
            tool(
                "ccode_com_slack__slack_schedule_message",
                "ccode_com_slack",
            ...
            tool(
                "ccode_com_slack__slack_search_channels",
                "ccode_com_slack",
            ...
            tool(
                "ccode_com_slack__slack_search_emojis",
                "ccode_com_slack",
                "slack_search_emojis",
            ...
            tool(
                "ccode_com_slack__slack_search_public",
                "ccode_com_slack",
                "slack_search_public",
            ...
            tool(
                "ccode_com_slack__slack_search_public_and_private",
                "ccode_com_slack",
            ...
            tool(
                "ccode_com_slack__slack_search_users",
                "ccode_com_slack",
                "slack_search_users",
            ...
            tool(
                "ccode_com_slack__slack_send_message_draft",
                "ccode_com_slack",
            ...
            tool(
                "ccode_com_slack__slack_update_canvas",
                "ccode_com_slack",
                "slack_update_canvas",
    ...
    fn haystack_exact_qualified_name() {
        ...
        let snap = index.search_snapshot("ccode_com_slack__slack_search_public", 5);
        assert_eq!(snap.results.len(), 1);
        assert_eq!(
            snap.results[0].tool_name,
            "ccode_com_slack__slack_search_public"
    ...
    fn haystack_disambiguate_search_public_vs_private() {
        ...
        let pub_pos = names
            .iter()
            .position(|n| *n == "ccode_com_slack__slack_search_public");
        let priv_pos = names
            .iter()
            .position(|n| *n == "ccode_com_slack__slack_search_public_and_private");
        assert!(
            pub_pos.is_some(),
    ...
    fn score_comparison_query_normalization() {
        ...
        let cases: &[(&str, &str)] = &[
            ...
            ("search_public", "ccode_com_slack__slack_search_public"),
