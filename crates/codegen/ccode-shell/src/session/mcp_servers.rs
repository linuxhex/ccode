...
use ccode_mcp::oauth_config::{McpOAuthConfig, McpOAuthConfigMap};
use ccode_mcp::servers as inner;
...
pub fn build_config_resolved_event(
    ...
    let servers = configs
        ...
        .collect();
    ccode_fs::events::Event::McpConfigResolved { servers, disabled }
}
