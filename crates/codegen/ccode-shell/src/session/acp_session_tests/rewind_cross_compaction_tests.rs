...
use crate::extensions::notification::{
    CompactionCheckpointFile, CompactionCheckpointInfo, SessionNotification as CcodeNotification,
    SessionUpdate as CcodeSessionUpdate,
};
...
async fn run_forked_rewind_scenario() {
    ...
    JsonlStorageAdapter::with_root(crate::util::ccode_home::ccode_home())
        .init_session(
            &source_info,
