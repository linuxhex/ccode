...
use ccode_agent::prompt::context::{PromptAudience, TemplateOverride};
use ccode_agent::system_reminder::{
    ...
    local
        .run_until(async {
            ...
            *actor.agent.borrow_mut() = test_agent_with_user_message_template(
                ccode_agent::prompt::user_message::UserMessageTemplate::Custom(
