...
//
// State is persisted to `~/.ccode/claude_import_state.json`.
...
use ccode_workspace::permission::claude_settings::find_claude_settings_paths;

// Types

/// Persistent import state, loaded from / saved to `~/.ccode/claude_import_state.json`.
...
fn state_path() -> PathBuf {
    crate::util::ccode_home::ccode_home().join("claude_import_state.json")
}
