...
pub(crate) mod hydrate {
    ...
    fn write_summary(
        ...
        let summary = Summary {
            ...
            head_branch: None,
            request_id: None,
            // Record the *local* ccode_home (where this hydrated copy lives),
            ...
            sandbox_profile: ccode_sandbox::configured_profile_name().map(String::from),
    ...
    const REPLAYABLE_METHODS: &[&str] = &["session/update", "_ccode.dev/session/update"];
