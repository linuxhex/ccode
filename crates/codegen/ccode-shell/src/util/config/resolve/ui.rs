...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "CCODE_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`CCODE_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "CCODE_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`CCODE_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "CCODE_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`CCODE_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `CCODE_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("CCODE_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes CCODE_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
