...
pub const ENV_DISPLAY_REFRESH_PROBE_ENABLED: &str = "CCODE_DISPLAY_REFRESH_PROBE_ENABLED";
pub const ENV_DISPLAY_REFRESH_AUTO_CADENCE: &str = "CCODE_DISPLAY_REFRESH_AUTO_CADENCE";
...
/// Same band as env cadence knobs (`CCODE_MIN_DRAW_MS` / `CCODE_SCROLL_CADENCE_MS`).
