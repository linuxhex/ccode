...
//! (Premium, Premium Heavy/Lite, X Premium/+, and any unknown future name)
...
mod tests {
    ...
    fn unrestricted_names() {
        assert!(!is_restricted_tier_name("Premium"));
        assert!(!is_restricted_tier_name("Premium Heavy"));
        assert!(!is_restricted_tier_name("premium_lite"));
