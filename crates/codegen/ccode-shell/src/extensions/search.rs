...
use ccode_workspace::file_system::ContentSearchRequest as ContentSearchRequestParams;
use ccode_workspace::workspace_ops::{FuzzyChangeReq, FuzzyCloseReq, FuzzyOpenReq};
...
pub async fn handle(agent: &MvpAgent, args: &acp::ExtRequest) -> ExtResult {
    match args.method.as_ref() {
        ...
        "ccode.dev/search/content" => {
            ...
            // `ccode.dev/search/content/status` batches through the client sink.
