...
mod tests {
    ...
    #[test]
    fn success_response_projects_ccode_workspace_fields() {
    ...
    fn degraded_response_carries_partial_reason() {
        ...
        assert_eq!(value["_meta"]["ccode.dev/partial"]["workspaces"], true);
        assert_eq!(value["_meta"]["ccode.dev/partial"]["reason"], "no_oauth");
    }
}
