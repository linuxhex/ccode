...
//! two ways:
//!
//!   - request/response `ccode.dev/sessions/list` → `{ "sessions": [RosterEntry, …] }`
//!   - broadcast notification `ccode.dev/sessions/changed` →
...
/// Response payload for `ccode.dev/sessions/list`.
#[derive(Serialize, Deserialize, Clone, Debug, Default)]
pub struct RosterListResponse {
    pub sessions: Vec<RosterEntry>,
}

/// Params payload for the `ccode.dev/sessions/changed` broadcast notification.
#[derive(Serialize, Deserialize, Clone, Debug, Default)]
...
pub const SESSIONS_LIST_METHOD: &str = "ccode.dev/sessions/list";
pub const SESSIONS_CHANGED_METHOD: &str = "ccode.dev/sessions/changed";
