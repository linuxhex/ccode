...
//! The shared coordinator actor lives in `ccode-tools`; this module plugs
...
impl ccode_tools::implementations::ccode_build::task::coordinator::ChildRunner
    for ShellChildRunner
{
    ...
    type RunFuture = ccode_tools::implementations::ccode_build::task::coordinator::LocalBoxFuture<
        ccode_tools::implementations::ccode_build::task::coordinator::ChildRunOutput<
            Self::CompletionData,
        >,
    >;
    type ValidateFuture =
        ccode_tools::implementations::ccode_build::task::coordinator::LocalBoxFuture<
            ccode_tools::implementations::ccode_build::task::types::SubagentValidateTypeOutcome,
        >;
    type DescribeFuture =
        ccode_tools::implementations::ccode_build::task::coordinator::LocalBoxFuture<
            ccode_tools::implementations::ccode_build::task::types::SubagentDescribeOutcome,
        >;
    fn run(
        &self,
        run: ccode_tools::implementations::ccode_build::task::coordinator::ChildRunRequest<
            Self::Control,
        >,
    ) -> Self::RunFuture {
        let agent_ref = self.agent_ref.clone();
        Box::pin(async move {
            let ccode_tools::implementations::ccode_build::task::coordinator::ChildRunRequest {
                request,
                cancellation,
                reporter,
            } = run;
            ...
            let Some(mut ctx) = this.try_build_subagent_spawn_context(&parent_sid) else {
                ...
                return ccode_tools::implementations::ccode_build::task::coordinator::ChildRunOutput {
                    result: ccode_tools::implementations::ccode_build::task::types::SubagentResult {
                        success: false,
                        error: Some(
        ...
        Box::pin(async move {
            ...
            match this.try_build_subagent_spawn_context(&parent_session_id) {
                ...
                None => {
                    ...
                    ccode_tools::implementations::ccode_build::task::types::SubagentDescribeOutcome::Unavailable
                }
            }
        })
    }
    fn on_completed(
        &self,
        completion: ccode_tools::implementations::ccode_build::task::coordinator::ChildCompletion<
            Self::CompletionData,
        >,
    ) {
...
impl MvpAgent {
    ...
    /// [`SubagentCoordinator`](ccode_tools::implementations::ccode_build::task::coordinator::SubagentCoordinator)
    ...
    pub(super) fn start_subagent_coordinator(&self) {
        ...
        let config =
            ccode_tools::implementations::ccode_build::task::coordinator::CoordinatorConfig {
                foreground_budget:
                    ccode_tools::implementations::ccode_build::task::backend::env_duration_or(
                        "CCODE_SUBAGENT_AWAIT_BUDGET_MS",
        ...
        tokio::task::spawn_local(
            ccode_tools::implementations::ccode_build::task::coordinator::SubagentCoordinator::new(
                    rx,
                    runner,
                    config,
                )
        ...
        let (
            ...
            (
                ...
                ps.map(|h| h.tool_context.hunk_tracker_handle.clone())
                    .unwrap_or_else(ccode_hunk::HunkTrackerHandle::noop),
                ...
                ps.map(|h| h.tool_context.fs.inner().clone())
                    .unwrap_or_else(|| {
                        let cwd = ps
                            ...
                            .unwrap_or_default();
                        std::sync::Arc::new(ccode_workspace::file_system::LocalFs::new(cwd))
                    }),
        ...
        Some(crate::agent::subagent::SubagentSpawnContext {
            ...
            task_output_tool_name: {
                ...
                sessions
                    ...
                    .unwrap_or_else(|| {
                        ccode_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
                            .to_string()
                    })
            },
