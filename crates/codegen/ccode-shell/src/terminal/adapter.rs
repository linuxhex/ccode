//! `AcpTerminalAdapter`: implements `ccode-tools::TerminalBackend` over ACP
...
use ccode_tools::computer::types::{
...
/// Wraps ccode-shell's ACP gateway to satisfy ccode-tools' TerminalBackend.
        ...
        tokio::spawn(async move {
            ...
            let mut wait_reply: Option<
                tokio::sync::oneshot::Sender<
                    ccode_acp::AcpResult<acp::WaitForTerminalExitResponse>,
                >,
            > = None;
