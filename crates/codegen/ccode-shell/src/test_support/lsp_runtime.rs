...
pub(crate) type GatewayOut = <acp::AgentSide as ccode_acp::AcpSide>::OutMessage;
...
pub(crate) fn ctx_with_toggle(toggle: HashMap<String, bool>) -> SubagentSpawnContext {
    ...
    SubagentSpawnContext {
        ...
        hunk_tracker_handle: ccode_hunk::HunkTrackerHandle::noop(),
        hunk_tracking_enabled: false,
        fs: Arc::new(ccode_workspace::file_system::LocalFs::new(
            PathBuf::from("/tmp"),
        )),
        ...
        auth_manager: Arc::new(crate::auth::AuthManager::new(
            std::path::Path::new("/tmp/nonexistent-ccode-test"),
        ...
        parent_skills: None,
        parent_skills_config: ccode_agent::prompt::skills::SkillsConfig::default(),
        parent_compat: ccode_tools::types::compat::CompatConfig::default(),
        task_completion_reservations: None,
        synthetic_trace_tx: None,
        task_output_tool_name: ccode_tools::reminders::task_completion::DEFAULT_TASK_OUTPUT_TOOL
            .to_string(),
...
impl ccode_tools::implementations::lsp::LspBackend for DummyLspDispatch {
    ...
    async fn dispatch(
        &self,
        _input: &ccode_tools::implementations::lsp::LspToolInput,
    ) -> ccode_tools::implementations::lsp::LspToolResult {
        ccode_tools::implementations::lsp::LspToolResult {
            text: String::new(),
            is_error: false,
        }
    ...
    ) -> Option<ccode_tools::implementations::lsp::DiagnosticsSummary> {
        None
    }
    ...
    ) -> Vec<ccode_tools::implementations::lsp::FileDiagnosticEntry> {
        vec![]
    }
}
