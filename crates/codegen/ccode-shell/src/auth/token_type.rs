...
impl TokenType {
    ...
    pub(crate) fn from_auth(auth: Option<&CcodeAuth>) -> Self {
        match auth {
            None => Self::None,
    ...
    pub(crate) fn telemetry_kind(self) -> ccode_telemetry::events::AuthTokenKind {
        use ccode_telemetry::events::AuthTokenKind as K;
        match self {
