...
pub(crate) trait ExternalCommandRunner: Send + Sync {
    ...
    async fn run_external_command(&self, command: &str) -> Option<CcodeAuth>;
}
...
impl RefreshOutcome {
    ...
    pub(crate) fn success(auth: CcodeAuth) -> Self {
...
mod tests {
    use super::*;
    use crate::auth::{AuthMode, CcodeAuth, CcodeComConfig};
