...
use super::super::CcodeAuth;
use super::protocol::{OidcError, OidcUserInfo, build_ccode_auth, discover, refresh_tokens};
...
pub(crate) async fn oidc_token_exchange(auth: &CcodeAuth) -> OidcRefreshResult {
    ...
    let mut new_auth = build_ccode_auth(tokens, user_info, issuer, client_id);
