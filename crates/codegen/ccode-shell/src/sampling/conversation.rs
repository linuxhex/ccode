...
//!
//! The canonical types now live in `ccode_sampling_types::conversation`.
//! This module re-exports them and adds ccode-shell-specific types
//! (`ConversationRequestTrace`) that depend on internal crate types.

// Re-export everything from the standalone crate.
pub use ccode_sampling_types::conversation::*;

// ============================================================================
// ccode-shell-specific types (depend on internal crate types)
// ============================================================================

/// Tracing context for conversation requests.
///
/// Stays in `ccode-shell` because it references
...
// via `Box::new(trace)`.
//
// Tests for conversation types now live in ccode-sampling-types crate.
