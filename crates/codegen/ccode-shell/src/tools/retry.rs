//! Retry utilities — re-exported from `ccode-tools`.
//!
//! The canonical implementation now lives in `ccode_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use ccode_tools::retry::BackoffConfig as RetryConfig;
pub use ccode_tools::retry::{BackoffConfig, execute_with_backoff};
