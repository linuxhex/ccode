...
//! ccode-tools. This struct is NOT used for tool execution — it's session infrastructure.
//!
...
pub(crate) fn subagent_foreground_wait(
    state: Arc<BlockingWaitState>,
) -> ccode_tools::implementations::ccode_build::task::types::SubagentForegroundWait {
    ccode_tools::implementations::ccode_build::task::types::SubagentForegroundWait::new(
...
pub struct ToolContext {
    ...
    pub lsp: Option<Arc<dyn ccode_tools::implementations::lsp::LspBackend>>,
    ...
    pub monitor_event_buffer:
        Option<ccode_tools::implementations::ccode_build::task::types::MonitorEventBuffer>,
    ...
    pub task_wake_suppressed:
        Option<ccode_tools::reminders::task_completion::TaskWakeSuppressed>,
...
impl ToolContext {
    ...
    pub fn new(
        ...
        let session_env = ccode_workspace::envrc::load_envrc_or_empty_when_trusted(
            cwd.as_path(),
