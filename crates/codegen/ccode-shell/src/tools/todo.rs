//! Todo types — re-exported from `ccode-tools` with ACP conversion helpers.
//!
//! Types are canonical in `ccode-tools`. This module adds ACP ↔ TodoItem
//! conversions since `ccode-tools` is protocol-agnostic.

pub use ccode_tools::implementations::ccode_build::todo::TodoId;
pub use ccode_tools::implementations::ccode_build::todo::TodoItem;
pub use ccode_tools::implementations::ccode_build::todo::TodoPriority;
pub use ccode_tools::implementations::ccode_build::todo::TodoState;
pub use ccode_tools::implementations::ccode_build::todo::TodoStatus;
