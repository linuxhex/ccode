//! Shared helpers for ccode-shell integration tests.

use ccode_shell::sampling::{ApiBackend, Client, SamplerConfig};
...
pub mod leader {
    ...
    use ccode_test_support::leader::{LeaderFixture, LeaderStdioClient};
...
pub fn test_sampler_config(
    ...
    // Shell `Client` is `ccode_sampler::SamplingClient`, which takes a
