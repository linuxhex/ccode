...
//! Ccode to persist important information across sessions. Memory files are
//! stored under `~/.ccode/memory/` with workspace-scoped subdirectories
...
//! `CCODE_MEMORY=1` environment variable. When disabled, this crate
