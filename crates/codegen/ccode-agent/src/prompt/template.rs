...
/// The base prompt template source, exposed for `ccode prompt --section template`.
...
/// Apply-patch prompt template source, exposed for `ccode prompt --section apply-patch-template`.
...
mod tests {
    ...
    /// Build a TemplateRenderer with the standard ccode-build tool kinds.
