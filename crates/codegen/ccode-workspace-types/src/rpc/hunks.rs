...
/// Wire-safe hunk action enum. Maps to `ccode_hunk::types::HunkAction`
...
// =========================================================================
// Request types whose responses reference `ccode_hunk` types (which pull
...
// =========================================================================
// Wire mirrors of `ccode_hunk` response types
// =========================================================================

/// Wire mirror of `ccode_hunk::types::Hunk` (the `selected` field is
...
/// Wire mirror of `ccode_hunk::types::HunkLineInfo`.
...
/// Wire mirror of `ccode_hunk::types::HunkSource`.
///
...
/// Wire mirror of `ccode_hunk::types::FileContentStatus`.
///
...
/// Wire mirror of `ccode_hunk::types::FileContentView`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `ccode_hunk::types::FileContentEntry`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `ccode_hunk::types::SessionStats`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `ccode_hunk::types::TurnSummary`.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Wire mirror of `ccode_hunk::types::SessionSummary`.
#[derive(Debug, Clone, Default, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
