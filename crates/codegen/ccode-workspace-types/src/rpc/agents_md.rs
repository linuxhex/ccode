...
/// Claude.md / `.ccode/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.ccode` and compat dirs.
...
/// Mirrors the serde shape of `ccode-agent`'s `AgentConfigFile`.
