...
//!
//! TODO(workspace): align with `ccode_hunk::Hunk` and
//! `ccode_hunk::HunkAction` when the hunk tracker's wire surface
...
///
/// TODO(workspace): align with `ccode_hunk::types::Hunk`.
...
///
/// TODO(workspace): align with `ccode_hunk::types::HunkAction`.
///
