...
//!
//! In dev mode, watches ~/.ccode/pager.toml for changes and hot-reloads.
...
///
/// In dev mode: reads from ~/.ccode/pager.toml, watches for changes.
...
impl ConfigWatcher {
    ...
    ///
    /// - In dev mode: reads/creates ~/.ccode/pager.toml, watches for changes
    ...
    fn start_static() -> io::Result<Self> {
        let config = ccode_config::user_ccode_home()
