//! CcodeNight theme — neutral gray base with TokyoNight accent colors.
//!
...
// CcodeNight palette — neutral gray base + TokyoNight accent colors.
//
...
impl Theme {
    /// CcodeNight theme — neutral gray base with TokyoNight accents.
    ///
