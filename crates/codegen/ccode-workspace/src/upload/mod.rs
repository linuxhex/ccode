...
use ccode_fs::gcs::StorageConfig;
use ccode_fs::queue::{EnqueueOutcome, TraceExportSource, UploadQueue};
use ccode_fs::storage_client::Auth401AttributionCallback;
use ccode_fs::{TraceExportConfig, UploadMethod};
use ccode_auth::{AuthCredentialProvider, CredentialSnapshot};
...
static UPLOAD_QUEUE_PENDING_BYTES: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "ccode_workspace_upload_queue_pending_bytes",
...
static UPLOAD_QUEUE_PENDING: LazyLock<IntGauge> = LazyLock::new(|| {
    register_int_gauge!(
        "ccode_workspace_upload_queue_pending",
...
static UPLOAD_OUTCOME_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "ccode_workspace_upload_outcome_total",
...
static UPLOAD_FAILED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "ccode_workspace_upload_failed_total",
...
static UPLOAD_SKIPPED_TOTAL: LazyLock<IntCounterVec> = LazyLock::new(|| {
    register_int_counter_vec!(
        "ccode_workspace_upload_skipped_total",
...
impl ccode_auth::visibility::HttpAuth for HubAuthCredentialProvider {
...
mod tests {
    use super::*;
    use ccode_hub_sdk::auth::AuthCredential;
