...
pub enum WorkspaceError {
    ...
    ///
    /// [`DeployError`]: ccode_workspace_types::rpc::deploy::DeployError
    #[error("deploy error: {message}")]
    DeployError {
        kind: ccode_workspace_types::rpc::deploy::DeployError,
        message: String,
    },
...
mod tests {
    ...
    use ccode_workspace_types::rpc::deploy::DeployError;
