...
// its wire types live in `ccode_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use ccode_workspace_types::rpc::fs::FsReadEncoding;
...
pub use ccode_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
