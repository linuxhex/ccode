//! Integration tests for ccode-sandbox.
//!
...
fn test_sandbox_logger() {
    use ccode_sandbox::{SandboxEvent, SandboxLogger};
...
fn test_should_restrict_child_network_default() {
    ...
    assert!(!ccode_sandbox::should_restrict_child_network());
}
