//! Installed ccode CLI version, lockstepped with shipping binaries.

use semver::Version;

pub const TEST_VERSION_ENV: &str = "CCODE_TEST_VERSION";

pub const VERSION: &str = match option_env!("CCODE_VERSION") {
    Some(v) => v,
