//! Public event types — the wire contract for `ccode-fsnotify`.
//!
...
//! translator (in `ccode-workspace`) maps these to
...
/// Aligned with `ccode_workspace_types::FsEventKind` (identity map at
