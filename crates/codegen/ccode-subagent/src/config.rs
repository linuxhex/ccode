...
//! `ccode_shell::config::{SubagentRole, SubagentPersona, PersonaIOField}`.
//!
//! Methods that remain in `ccode-shell` (on `SubagentsConfig`):
...
"#;
        ...
        assert_eq!(persona.model.as_deref(), Some("ccode-3-fast"));
