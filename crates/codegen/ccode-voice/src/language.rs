//! Ccode Speech-to-Text language codes.
//!
//! Source of truth for the `language` query/form parameter on
//! `https://api.ccode.dev/v1/stt` and `wss://api.ccode.dev/v1/stt`.
//!
//! Official catalog (25 languages):
//! <https://docs.ccode.dev/developers/model-capabilities/audio/speech-to-text#supported-languages>
//!
...
/// Official Ccode STT languages (docs.ccode.dev), sorted by English name.
///
...
mod tests {
    ...
    fn catalog_matches_public_docs_exactly() {
        ...
        assert_eq!(
            ours, docs,
            "STT_LANGUAGES drifted from docs.ccode.dev supported languages"
        );
    }
