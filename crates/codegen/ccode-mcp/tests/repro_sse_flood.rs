...
//!
//! Run with: cargo test -p ccode-mcp --test repro_sse_flood -- --nocapture
...
use ccode_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use ccode_mcp::rmcp::ServiceExt;
use ccode_mcp::rmcp::transport::StreamableHttpClientTransport;
use ccode_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
