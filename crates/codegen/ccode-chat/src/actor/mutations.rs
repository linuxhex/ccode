...
impl ChatStateActor {
    ...
    /// Out-of-band history repair (`ccode.dev/session/repair`): run
        ...
        self.state
            ...
            .map(|item| match item {
                ...
                ConversationItem::Reasoning(r) => {
                    ccode_sampling_types::reasoning_item_text(r).len()
    ...
    pub(super) fn record_last_turn_usage(&mut self, usage: ccode_sampling_types::TokenUsage) {
    ...
    pub(super) fn record_model_call_usage(
        ...
        usage: &ccode_sampling_types::TokenUsage,
