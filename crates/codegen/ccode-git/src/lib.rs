...
const ENV_THREADS: &str = "CCODE_GIX_STATUS_THREADS";
...
/// Production budget (`n >= 1`). Honours `CCODE_GIX_STATUS_THREADS=N` for `N >= 1`
...
mod tests {
    ...
    use ccode_test_utils::git::run_git;
...
mod nproc_tests {
    ...
    const CHILD_ENV: &str = "CCODE_GIX_STATUS_NPROC_CHILD";
    const REPO_ENV: &str = "CCODE_GIX_STATUS_NPROC_REPO";
