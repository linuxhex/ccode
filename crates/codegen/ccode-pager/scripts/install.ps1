#
# Ccode CLI installer for PowerShell — https://ccode.dev/cli/install.ps1
#
...
#
# Usage:
#   irm https://ccode.dev/cli/install.ps1 | iex                                       # latest stable
#   & ([scriptblock]::Create((irm https://ccode.dev/cli/install.ps1))) -Version 0.1.42 # specific version
#   $env:GROK_VERSION="0.1.42"; irm https://ccode.dev/cli/install.ps1 | iex           # specific version (alt)
#   $env:GROK_DEPLOYMENT_KEY="<key>"; irm https://ccode.dev/cli/install.ps1 | iex
#
...
if ($PSVersionTable.Platform -and $PSVersionTable.Platform -ne 'Win32NT') {
    Write-Error "This installer is for Windows. On macOS/Linux, use: curl -fsSL https://ccode.dev/cli/install.sh | bash"
    exit 1
}
