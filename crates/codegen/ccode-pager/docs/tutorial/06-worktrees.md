...
Want Ccode working on a feature while you (or another Ccode session) work on
...
- **From the shell:**
  ...
  ```bash
  ccode --worktree=my-feature "refactor the auth module"
  ```
...
- Run two or three Ccode sessions on the same repo simultaneously.
