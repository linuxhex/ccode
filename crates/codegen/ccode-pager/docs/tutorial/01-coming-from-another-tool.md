...
Fear not — your settings, rules, and skills come with you. Ccode Build
...
writes the items you selected into your `.ccode` config. Re-run it anytime.
...
Run **`ccode inspect`** in a repo to see every rules file, skill, and MCP
server Ccode picked up, tagged with where it came from. Each compat source
