# Ccode Build User Guide

Learn how to install, configure, and extend Ccode Build, the terminal-based AI coding assistant from SpaceCcode.
...
Customize and extend Ccode Build.
...
Automate, script, and integrate Ccode Build with other systems.

| # | Document | Description |
|---|----------|-------------|
| 14 | [Headless Mode and Scripting](14-headless-mode.md) | `ccode -p`, output formats, CI/CD integration, and piping |
