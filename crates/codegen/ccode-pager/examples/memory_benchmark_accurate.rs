...
fn main() {
    ...
    let string_info = create_string_info(1, "general-purpose", "ccode-3", "researcher");
    let arc_info = create_arc_info(1, "general-purpose", "ccode-3", "researcher");
    ...
    let shared_models = ["ccode-3", "ccode-3-mini"];
