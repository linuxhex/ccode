...
Terminal UI (TUI) for Ccode Build. Provides the interactive full-screen interface
...
- [Hook Examples](../ccode-hooks/examples/README.md) — sample hooks for common workflows
- [Hooks Crate (`ccode-hooks`)](../ccode-hooks/) — hook runtime, event types, and execution engine
- [Plugin Marketplace Crate (`ccode-marketplace`)](../ccode-marketplace/) — marketplace source loading, scanning, and install
