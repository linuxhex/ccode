...
//!
//! ```text
//! cargo bench -p ccode-pager --bench edit_highlight
//! cargo bench -p ccode-pager --bench edit_highlight -- edit_hl/upgrade
//! ```
...
use ccode_pager::diff::{DiffHunk, DiffLine};
use ccode_pager::scrollback::blocks::tool::{
...
use ccode_pager::syntax::{Syntect, get_syntect};
