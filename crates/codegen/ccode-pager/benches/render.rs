//! Criterion benchmarks for the ccode-pager rendering pipeline.
//!
...
use ccode_pager::scrollback::render::render_scrolled_entries_with_scratch;
use ccode_pager::scrollback::wrappers::EntryRenderer;
use ccode_pager::scrollback::{
