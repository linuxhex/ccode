...
//! render mode.
//!
//! `ccode-pager` cannot depend on `ccode-pager-minimal`: that crate reads
...
//!
//! The composition-root binary (`ccode-pager-bin`) wires it up once at
//! startup by calling `ccode_pager_minimal::install()`. When nothing has
