...
const CODING_DATA_SHARING_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        canonical: "opt-in",
        display: "Opt in",
        description: "Allow SpaceCcode to retain coding session data for model training and product improvement.",
    },
    EnumChoice {
        canonical: "opt-out",
        display: "Opt out",
...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Open plain ccode in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Open plain ccode in scrollback-native (minimal) mode.",
    },
];
...
//
// Concrete codes must match `ccode_voice::STT_LANGUAGES` (official Ccode STT
// catalog — https://docs.ccode.dev/developers/model-capabilities/audio/speech-to-text).
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How plain ccode opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` resolved to "ccode-night".
                default: "ccode-night",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "ccode-night".
                default: "ccode-night",
        ...
        SettingMeta {
            ...
            kind: SettingKind::Enum {
                // `Option<String>` — `None` falls back to "ccode-day".
                default: "ccode-day",
                choices: CONCRETE_THEME_CHOICES,
                supports_preview: true,
            },
        ...
        SettingMeta {
            ...
            keywords: &["model", "default", "agent", "llm", "ccode", "switch"],
        ...
        // The `CCODE_PROMPT_SUGGESTIONS` env var overrides at runtime.
        SettingMeta {
        ...
        SettingMeta {
            ...
            description: "Controls whether SpaceCcode may retain and train on coding session \
        ...
        // follows the process locale when it maps to a Ccode STT language.
        // Catalog = official STT languages (see ccode_voice::STT_LANGUAGES).
        SettingMeta {
            key: "voice_stt_language",
            category: SettingCategory::Editor,
            owner: SettingOwner::Shell,
            label: "Voice language",
            description: "Speech-to-text language for voice dictation (Ccode STT). \
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "SSH wrap",
            description: "Show a `/doctor` tip when an SSH session is not using `ccode wrap`.",
            keywords: &[
                "ssh",
                "wrap",
                "remote",
