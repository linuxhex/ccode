...
pub mod detection {
    pub use ccode_fs::workspace_classifier::is_project_dir;
}
pub mod sources;

use std::path::{Path, PathBuf};

use ccode_tools::implementations::ccode_build::ask_user_question::{Question, QuestionOption};
...
pub fn build_project_question(
    ...
    ProjectQuestion {
        question: Question {
            question: "Run Ccode Build in a project directory?\n\n\
                 This gives Ccode Build full context of your codebase for better results."
                .into(),
            id: None,
            options,
