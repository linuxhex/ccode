    ...
    let response = ccode_hooks_types::MarketplaceListResponse {
        sources: vec![
            ...
            ccode_hooks_types::MarketplaceScanResult {
                ...
                source_kind: "git".into(),
                source_url_or_path: "git@github.com:ccode-org/plugin-marketplace.git".into(),
...
mod cta_e2e {
    ...
    fn figma_candidate() -> ccode_hooks_types::MarketplacePluginEntry {
        let mut entry = cta_entry("figma", "not_installed");
    ...
    fn happy_path_with_auth_handoff() {
        ...
        let servers = vec![
            cta_mcp_server("ccode_com_managed", None, McpServerDisplayStatus::Ready),
    ...
    fn dismissed_plugin_suppressed_on_next_recompute() {
        ...
        let dismissed = ccode_shell::config::dismissed_plugin_ctas_in_file(&config_path);
        let matched =
        ...
        ccode_shell::config::add_dismissed_plugin_cta_to_file("figma", &config_path)
