...
fn content_hit(id: &str) -> ccode_shell::extensions::session_search::SearchSessionHit {
...
fn external_filter_clears_and_suppresses_native_content_state() {
    ...
    // Ccode cycles straight into External.
    app.session_picker_source_filter = SourceFilter::Ccode;
...
fn modal_external_filter_clears_native_content_and_blocks_forced_search() {
    ...
    {
        // Ccode cycles straight into External.
        *source_filter = SourceFilter::Ccode;
