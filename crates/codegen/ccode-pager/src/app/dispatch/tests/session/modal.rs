...
fn open_extensions_modal_no_session_sets_flag_no_fetches() {
    ...
    let effects = dispatch(
        Action::OpenExtensionsModal {
            ...
            trigger: ccode_telemetry::events::ExtensionsModalTrigger::SlashCommand,
        },
        &mut app,
    );
...
fn success_outcome() -> ccode_hooks_types::ActionOutcome {
...
fn empty_marketplace_response() -> ccode_hooks_types::MarketplaceListResponse {
    ccode_hooks_types::MarketplaceListResponse { sources: vec![] }
}
