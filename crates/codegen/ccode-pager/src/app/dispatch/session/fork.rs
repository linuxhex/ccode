...
-> [ccode_tools::implementations::ccode_build::ask_user_question::QuestionOption; 2] {
    use ccode_tools::implementations::ccode_build::ask_user_question::QuestionOption;
    [
        QuestionOption {
...
/// [`Effect::ForkSession`] which calls `ccode.dev/session/fork` directly.
