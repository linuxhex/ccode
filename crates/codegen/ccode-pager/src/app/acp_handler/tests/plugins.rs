#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    fn plugins_changed_update_refreshes_data_without_reseeding_collapse_state() {
        ...
        modal.plugins_data =
            TabDataState::Loaded(ccode_hooks_types::PluginsListResponse { plugins: vec![] });
        ...
        let handled = handle(
            make_ext_session_notification(
                "sess-plugins",
                CcodeSessionUpdate::PluginsChanged {
                    plugins: vec![crate::views::extensions_modal::test_plugin_info(
                        "user-tool",
                        Some(ccode_hooks_types::PluginOrigin::UserCcode),
                    )],
                },
            ),
            &mut app,
            ...
            make_ext_session_notification(
                ...
                CcodeSessionUpdate::PluginsChanged {
                    plugins: vec![
                        ...
                        crate::views::extensions_modal::test_plugin_info(
                            "claude-tool",
                            Some(ccode_hooks_types::PluginOrigin::UserClaude),
                        ),
                    ],
                },
            ),
