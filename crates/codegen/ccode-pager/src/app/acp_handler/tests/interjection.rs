#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// and the shell emits the queue-emptying `ccode.dev/queue/changed` right after
    ...
    /// `ccode.dev/task_backgrounded` arriving after the skipped zero-work wait
    /// re-evaluates and restores the park.
    #[test]
    ...
    fn interjection_notification_pushes_block_to_matching_session() {
        ...
        // the shell as ccode.dev/session/interjection; EVERY attached pane (incl.
