#![cfg_attr(rustfmt, rustfmt::skip)]
    ...
    /// notifications through the generic `ccode.dev/session/update` envelope. A
    ...
    fn ext_session_update_replay_restores_bg_task() {
        ...
        let update = CcodeSessionUpdate::TaskBackgrounded {
        ...
        handle(
            make_ext_session_notification_with_method("sess-1", "ccode.dev/session/update", update),
            &mut app,
        );
    ...
    fn task_backgrounded_with_wire_description_still_drains_deferred_tool() {
        ...
        let notif = acp::ExtNotification::new("ccode.dev/task_backgrounded", raw.into());
