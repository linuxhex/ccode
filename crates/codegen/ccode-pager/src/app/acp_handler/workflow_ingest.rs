...
fn upsert_workflow_block(
    ...
    objective: &str,
    status: &str,
    phases: &[ccode_shell::extensions::notification::WorkflowPhaseInfo],
...
pub(super) fn ingest_workflow_update(agent: &mut AgentView, update: CcodeSessionUpdate) -> bool {
    let CcodeSessionUpdate::WorkflowUpdated {
        run_id,
        revision,
        name,
        objective,
