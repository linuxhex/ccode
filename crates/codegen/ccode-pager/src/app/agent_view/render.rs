...
impl AgentView {
    ...
    pub fn draw(
        ...
        if let Some(profile) = ccode_sandbox::profile_name() {
        ...
        let mut inline_edit_cursor: Option<(u16, u16)> = None;
        {
                ...
                && let Some(search) = self.scrollback_search.as_ref()
            {
                ...
                crate::views::picker::render_search_bar_with_viewport(
                    ...
                    !search.is_composing(),
                    None,
                    viewport.unwrap_or(ccode_textarea::SingleLineViewport {
            ...
            if route.emit_osc8 {
                ...
                *link_spans_out = self
                    ...
                    .filter_map(|link| {
                        ...
                        .map(|url| ccode_ratatui::LinkSpan {
                            row: link.screen_row,
...
mod toast_fit_tests {
    ...
    fn long_message_truncates_with_ellipsis_instead_of_vanishing() {
        let msg = "Copied via OSC 52 — also saved to /tmp/ccode-0/last-copy.txt. If paste fails, hold Shift (or Fn) and drag to select & copy natively.";
