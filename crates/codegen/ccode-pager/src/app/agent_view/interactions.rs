...
impl AgentView {
    ...
    fn submit_question_answers(&mut self, skipped: bool) -> InputOutcome {
        use ccode_tools::implementations::ccode_build::ask_user_question::AskUserQuestionExtResponse;
        self.swap_question_freeform();
        ...
        ccode_telemetry::session_ctx::log_event(ccode_telemetry::events::PlanSubmit {
...
mod permission_scope_key_tests {
    ...
    fn setup_bash_permission(agent: &mut AgentView) {
        ...
        perm.bash_highlights = Some(
            ccode_workspace::permission::bash_command_splitting::BashCommandHighlights {
                prefix: vec![],
...
mod question_no_freeform_tests {
    ...
    //! the Premium upsell. Regression tests for the bug where clicking
    ...
    fn upsell_question() -> Question {
        ...
        Question {
            ...
            options: vec![
                opt("Upgrade to Premium", "For everyday coding"),
                opt("Upgrade to Premium Heavy", "Highest usage limits"),
            ],
