...
const HERO_SUBTITLE: &str = "Thanks for trying Ccode Build, give feedback with /feedback!";
...
pub(super) fn compute_hero_box(
    ...
    announcement: Option<&ccode_announcements::RemoteAnnouncement>,
    expanded: bool,
...
managed devices and accounts. Report security incidents";
    ...
    fn upgrade_cta_reserves_rows_and_returns_button_rect() {
        ...
        let a = ann(None, Some("Ccode 4.5 is here. Upgrade now."));
        ...
        let mut pinned = ann(None, Some("Ccode 4.5 is here. Upgrade now."));
        pinned.dismissible = Some(false);
        pinned.cta = Some(ccode_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://ccode.dev/ccode".into()),
        ...
        let mut dismissible = ann(None, Some("Ccode 4.5 is here. Upgrade now."));
        dismissible.cta = Some(ccode_announcements::AnnouncementCta {
            label: Some("Upgrade Account".into()),
            url: Some("https://ccode.dev/ccode".into()),
            caption: Some("or use Ctrl+O".into()),
        });
