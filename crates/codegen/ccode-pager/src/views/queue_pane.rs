...
pub enum QueueRowOrigin {
    ...
    /// while running). Edits route to the agent as `ccode.dev/queue/*`.
    Server,
}
...
pub struct QueuePane {
    ...
    /// `bg_highlight` — e.g. CcodeNight's dark band leaking into CcodeDay).
...
impl QueuePane {
    ...
    pub fn render(
        ...
        // at construction (default CcodeNight, dark) after the user switches —
        // painting a dark band on a light CcodeDay canvas.
...
mod tests {
    ...
    fn yank_selected_multiline_copies_full_text() {
        ...
        use ccode_textarea::ClipboardProvider;
