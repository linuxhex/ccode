...
impl MemoryModalState {
    ...
    #[cfg(test)]
    fn query_viewport(&self, width: usize) -> ccode_textarea::SingleLineViewport {
...
pub fn build_entries(
    files: Vec<ccode_shell::extensions::notification::MemoryFileInfo>,
) -> Vec<MemoryFileEntry> {
...
mod tests {
    ...
    fn file_label_extracts_filename() {
        assert_eq!(file_label("/home/user/.ccode/memory/MEMORY.md"), "MEMORY.md");
        assert_eq!(
            file_label("/workspace/.ccode/memory/sessions/2026-01-15-fix-bug.md"),
    ...
    fn build_entries_groups_by_source() {
        use ccode_shell::extensions::notification::MemoryFileInfo;
