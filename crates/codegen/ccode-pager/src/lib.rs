...
// minimal rendering lives in the sibling `ccode-pager-minimal` crate; these
...
// `ccode-pager-render`. Re-exported at the crate root so existing
// `crate::<module>::...` references throughout the pager keep resolving.
pub use ccode_pager_render::{
