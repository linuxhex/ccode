...
//! `/docs web` opens https://docs.ccode.dev/build/overview in the browser.
...
/// Online Build docs landing page (hardcoded like other TUI deep-links; docs.ccode.dev can redirect if the path moves).
pub const BUILD_DOCS_URL: &str = "https://docs.ccode.dev/build/overview";
    ...
    fn suggest_args(&self, _ctx: &AppCtx, _args_query: &str) -> Option<Vec<ArgItem>> {
        let mut items = vec![
            ...
            ArgItem {
                ...
                description: "Open docs.ccode.dev/build in the browser".into(),
            },
        ];
