...
use crate::implementations::ccode_build::ask_user_question::AskUserQuestionInput;
use crate::implementations::ccode_build::enter_plan_mode::EnterPlanModeInput;
use crate::implementations::ccode_build::exit_plan_mode::ExitPlanModeInput;
use crate::implementations::ccode_build::grep::GrepSearchInput;
use crate::implementations::ccode_build::image_edit::ImageEditInput;
use crate::implementations::ccode_build::image_gen::ImageGenInput;
use crate::implementations::ccode_build::list_dir::ListDirInput;
use crate::implementations::ccode_build::read_file::ReadFileInput;
use crate::implementations::ccode_build::search_replace::SearchReplaceInput;
use crate::implementations::ccode_build::todo::TodoWriteInput;
use crate::implementations::ccode_build::update_goal::UpdateGoalInput;
use crate::implementations::ccode_build::video_gen::{ImageToVideoInput, ReferenceToVideoInput};
use crate::implementations::ccode_build::web_fetch::WebFetchInput;
use crate::implementations::ccode_build::web_search::WebSearchInput;
...
use ccode_tool_types::KillTaskToolInput;
use ccode_tool_types::TaskOutputToolInput;
use ccode_tool_types::TaskToolInput;
use ccode_tool_types::WaitTasksToolInput;
...
pub enum ToolInput {
    ...
    HashlineEdit(crate::implementations::ccode_build_hashline::edit::types::HashlineEditInput),
    ...
    Lsp(LspToolInput),
    Monitor(crate::implementations::ccode_build::monitor::types::MonitorInput),
    SchedulerCreate(crate::implementations::ccode_build::scheduler::create::SchedulerCreateInput),
    SchedulerDelete(crate::implementations::ccode_build::scheduler::delete::SchedulerDeleteInput),
    SchedulerList(crate::implementations::ccode_build::scheduler::list::SchedulerListInput),
    UpdateGoal(UpdateGoalInput),
    Workflow(crate::implementations::ccode_build::workflow::WorkflowToolInput),
