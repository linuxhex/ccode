...
crate::register_resource!("ccode_build", "ListDir", ListDirParams);
...
impl ccode_tool_runtime::Tool for ListDirTool {
...
mod tests {
    ...
    fn tool_name_and_description() {
        ...
        let tool = ListDirTool;
        assert_eq!(ccode_tool_runtime::Tool::id(&tool).as_str(), "list_dir");
