...
pub const USER_AGENT_STRING: &str = "Mozilla/5.0 (compatible; ccode-agent/1.0; +https://ccode.dev)";
...
pub struct WebFetchParams {
    ...
    /// allow_local = true` or `CCODE_WEB_FETCH_ALLOW_LOCAL=1`.
    #[serde(default)]
    pub allow_local: Option<bool>,
}

register_resource!("ccode_build", "WebFetch", WebFetchParams);
