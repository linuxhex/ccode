...
impl ccode_tool_runtime::ToolOutput for SchedulerCreateOutput {}
...
impl ccode_tool_runtime::Tool for SchedulerCreateTool {
    type Args = SchedulerCreateInput;
    type Output = SchedulerCreateOutput;

    fn id(&self) -> ccode_tool_protocol::ToolId {
        ccode_tool_protocol::ToolId::new(SCHEDULER_CREATE_TOOL_NAME).expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerCreateOutput, ccode_tool_runtime::ToolError> {
...
mod tests {
    use super::*;
    use crate::implementations::ccode_build::scheduler::actor::SchedulerActor;
