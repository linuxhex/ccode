...
pub fn scheduler_tool_error(error: SchedulerError) -> ccode_tool_runtime::ToolError {
    ...
    ccode_tool_runtime::ToolError::custom(code, error.to_string())
}
...
crate::register_resource!("ccode_build", "Scheduler", SchedulerState);
