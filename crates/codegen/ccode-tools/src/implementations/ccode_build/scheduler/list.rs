...
impl ccode_tool_runtime::ToolOutput for SchedulerListOutput {}
...
impl ccode_tool_runtime::Tool for SchedulerListTool {
    type Args = SchedulerListInput;
    type Output = SchedulerListOutput;

    fn id(&self) -> ccode_tool_protocol::ToolId {
        ccode_tool_protocol::ToolId::new("scheduler_list").expect("valid tool id")
    }
    ...
    ) -> Result<SchedulerListOutput, ccode_tool_runtime::ToolError> {
        ...
        sender
            ...
            .map_err(|_| {
                ccode_tool_runtime::ToolError::execution(
                    ccode_tool_protocol::ToolId::new("scheduler_list").expect("valid"),
