...
impl crate::types::tool_metadata::ToolMetadata for ReadFileConciseTool {
    ...
    fn tool_namespace(&self) -> ToolNamespace {
        ToolNamespace::CcodeBuildConcise
    }
...
impl ccode_tool_runtime::Tool for ReadFileConciseTool {
    ...
    async fn run(
        ...
        // CcodeBuildConcise is not version-managed — always pass None.
...
mod tests {
    ...
    use crate::implementations::ccode_build::read_file::ReadFileTool;
