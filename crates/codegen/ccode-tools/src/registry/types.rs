use crate::{
    ...
    implementations::{
        codex, ccode_build, ccode_build_concise, ccode_build_hashline, opencode,
...
/// this crate: instead of `ccode-tools` referencing an out-of-tree tool
/// pack, the pack calls
...
impl ToolConfig {
    ...
    /// `ccode_tool_runtime::Tool::id()`. Use this for built-in tools known
    ...
    where
        T: crate::types::tool_metadata::ToolMetadata + ccode_tool_runtime::Tool + Default,
    {
        Self::from(&T::default())
    }
...
impl<T: crate::types::tool_metadata::ToolMetadata + ccode_tool_runtime::Tool> From<&T>
    for ToolConfig
{
    fn from(tool: &T) -> Self {
        Self {
...
pub struct SubagentSessionResources {
    pub backend: crate::implementations::ccode_build::task::backend::SubagentBackendResource,
    ...
    pub event_sender: crate::implementations::ccode_build::task::types::SubagentEventSender,
    pub depth: crate::implementations::ccode_build::task::types::SubagentDepthCounter,
    pub session_id: crate::implementations::ccode_build::task::types::SessionIdResource,
}
...
pub struct SessionContext {
    ...
    pub parent_scheduler_handle:
        Option<crate::implementations::ccode_build::scheduler::types::SchedulerHandle>,
    ...
    pub web_fetch_config: crate::implementations::ccode_build::web_fetch::WebFetchConfig,
    ...
    /// call the ccode Imagine API. When `Disabled` (default), the tool is not
    /// registered and image generation is unavailable.
    pub image_gen_config: crate::implementations::ccode_build::image_gen::ImageGenConfig,
    ...
    /// call the ccode Video Generation API. When `Disabled` (default), the tool is not
    /// registered and video generation is unavailable.
    pub video_gen_config: crate::implementations::ccode_build::video_gen::VideoGenConfig,
    ...
    pub app_builder_deployer_config:
        crate::implementations::ccode_build::deploy_app::AppBuilderDeployerConfig,
    ...
    /// Auth provider which returns a ccode_hub_sdk::AuthCredential. Can be used by
    ...
    pub auth_provider: Option<ccode_hub_sdk::SharedAuthProvider>,
...
pub async fn drain_value_stream(
    mut stream: ccode_tool_runtime::ToolStream<ccode_tool_runtime::TypedToolOutput>,
) -> Result<serde_json::Value, ccode_tool_runtime::ToolError> {
    use futures::StreamExt;
    while let Some(item) = stream.next().await {
        match item {
            ccode_tool_runtime::ToolStreamItem::Progress(_) => continue,
            ccode_tool_runtime::ToolStreamItem::Terminal(result) => {
...
fn stream_no_terminal_error() -> ccode_tool_runtime::ToolError {
    ccode_tool_runtime::ToolError::custom(
        "stream_no_terminal",
...
struct DispatchParts {
    ...
    lr_handle: Arc<dyn ccode_hub_core::ToolHandle>,
...
struct ToolEntry {
    ...
    parse_input: Box<
        dyn Fn(serde_json::Value) -> Result<ToolInput, ccode_tool_runtime::ToolError> + Send + Sync,
    >,
    /// Registers this tool into a `LocalRegistry` using the concrete type.
    /// Captured at `register::<T>()` time when T is known.
    register_in_local: Box<dyn Fn(&ccode_hub_sdk::LocalRegistry) + Send + Sync>,
}
...
pub struct FinalizedToolset {
    ...
    local_registry: ccode_hub_sdk::LocalRegistry,
    ...
    workspace_viewer_ctx: Option<ccode_tool_runtime::WorkspaceViewerContext>,
}
#[derive(Debug, Clone, serde::Serialize, serde::Deserialize)]
...
pub struct ToolRegistryBuilder {
    ...
    shared_local_registry: Option<ccode_hub_sdk::LocalRegistry>,
}
...
impl ToolRegistryBuilder {
            ...
            + 'static,
    {
        ...
        let id = ccode_tool_runtime::Tool::id(&tool).as_str().to_string();
        let kind = tool.kind();
        ...
        self.tools.insert(
            ...
            ToolEntry {
                ...
                register_in_local: Box::new(|lr: &ccode_hub_sdk::LocalRegistry| {
    ...
    /// Fully-qualified tool id (`"CcodeBuild:read_file"`) → declared
    ...
    pub fn new() -> Self {
        ...
        b.register_with_params::<ccode_build::BashTool, ccode_build::bash::BashParams>();
        b.register_with_params::<ccode_build::ReadFileTool, ccode_build::read_file::ReadFileParams>();
        b.register_with_params::<
                ccode_build::SearchReplaceTool,
                ccode_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<ccode_build::ListDirTool, ccode_build::list_dir::ListDirParams>();
        b.register_with_params::<ccode_build::GrepTool, ccode_build::grep::GrepParams>();
        b.register::<ccode_build::KillTaskTool>();
        b.register::<ccode_build::KillTerminalCommandTool>();
        b.register::<ccode_build::TodoWriteTool>();
        b.register::<ccode_build::UpdateGoalTool>();
        b.register::<ccode_build::WorkflowTool>();
        b.register::<ccode_build::TaskOutputTool>();
        b.register::<ccode_build::GetTerminalCommandOutputTool>();
        b.register::<ccode_build::WaitTasksTool>();
        b.register::<ccode_build::TaskTool>();
        b.register::<ccode_build::WebSearchTool>();
        b.register_with_params::<ccode_build::WebFetchTool, ccode_build::web_fetch::WebFetchParams>();
        b.register::<ccode_build::LspTool>();
        b.register::<ccode_build::ImageGenTool>();
        b.register::<ccode_build::ImageEditTool>();
        b.register::<ccode_build::ImageToVideoTool>();
        b.register::<ccode_build::ReferenceToVideoTool>();
        b.register::<ccode_build::EnterPlanModeTool>();
        b.register::<ccode_build::ExitPlanModeTool>();
        b.register_with_params::<
                ccode_build::AskUserQuestionTool,
                ccode_build::ask_user_question::AskUserQuestionParams,
            >();
        b.register::<ccode_build::MonitorTool>();
        b.register::<ccode_build::SchedulerCreateTool>();
        b.register::<ccode_build::SchedulerDeleteTool>();
        b.register::<ccode_build::SchedulerListTool>();
        ...
        b.register_with_params::<
            ...
            >();
        b.register_with_params::<
                ccode_build_concise::ReadFileConciseTool,
                ccode_build::read_file::ReadFileParams,
            >();
        b.register_with_params::<
                ccode_build_concise::SearchReplaceConciseTool,
                ccode_build::search_replace::SearchReplaceParams,
            >();
        b.register_with_params::<
                ccode_build_concise::BashConciseTool,
                ccode_build::bash::BashParams,
            >();
        b.register_with_params::<
                ccode_build_hashline::HashlineReadTool,
                ccode_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                ccode_build_hashline::HashlineEditTool,
                ccode_build_hashline::config::HashlineSchemeParams,
            >();
        b.register_with_params::<
                ccode_build_hashline::HashlineGrepTool,
                ccode_build_hashline::config::HashlineSchemeParams,
            >();
    ...
    pub fn with_local_registry(mut self, registry: ccode_hub_sdk::LocalRegistry) -> Self {
    ...
    pub fn validate_config(&self, config: &ToolServerConfig) -> Vec<RequirementError> {
        ...
        }
        {
            let standard_file_ids: &[&str] = &[
                "CcodeBuild:read_file",
                "CcodeBuild:search_replace",
                "CcodeBuild:grep",
            ];
            let hashline_file_ids: &[&str] = &[
                "CcodeBuildHashline:hashline_read",
                "CcodeBuildHashline:hashline_edit",
                "CcodeBuildHashline:hashline_grep",
            ];
    ...
    pub fn finalize_with_trunc_config(
        ...
        if ctx.image_gen_config.has_credentials() {
            match crate::implementations::ccode_build::image_gen::ImageGenClient::new(
        ...
        if ctx.video_gen_config.is_enabled() {
            match crate::implementations::ccode_build::video_gen::VideoGenClient::new(
        ...
        if let crate::implementations::ccode_build::web_fetch::WebFetchConfig::Enabled { params } =
            &ctx.web_fetch_config
        {
            match crate::implementations::ccode_build::web_fetch::WebFetchClient::new(params) {
                Ok(client) => {
                    resources.insert(client);
                }
                Err(e) => {
        ...
        let concise_ns = crate::types::tool::ToolNamespace::CcodeBuildConcise.to_string();
        ...
        resources.register_state::<crate::implementations::ccode_build::todo::TodoState>();
        ...
        resources
            ...
            >();
        resources
            .register_state::<crate::implementations::ccode_build::scheduler::types::SchedulerState>(
            );
        ...
        let (scheduler_cmd_rx, scheduler_cancel_token) =
            if let Some(parent_handle) = ctx.parent_scheduler_handle {
                ...
                resources.insert(
                    crate::implementations::ccode_build::scheduler::types::SchedulerHandle(
                        scheduler_cmd_tx,
                    ),
                );
        ...
        if let (Some(cmd_rx), Some(cancel_token)) = (scheduler_cmd_rx, &scheduler_cancel_token) {
            let actor = crate::implementations::ccode_build::scheduler::actor::SchedulerActor {
...
///
/// Implements the canonical `ccode_tool_runtime::ToolDispatch` trait so the
...
#[async_trait::async_trait]
impl ccode_tool_runtime::ToolDispatch for InnerDispatchForToolset {
    async fn call(
        &self,
        ...
        let result = self
            ...
            .and_then(|output| {
                let value = serde_json::to_value(&output).map_err(|e| {
                    ccode_tool_runtime::ToolError::custom("output_encoding", e.to_string())
                })?;
                Ok(ccode_tool_runtime::TypedToolOutput::from_value(
                    tool_id.clone(),
                    value,
                ))
            });
        ccode_tool_runtime::terminal_only(result)
    }
}
impl FinalizedToolset {
    ...
    pub fn empty_for_test() -> Self {
        Self {
            ...
            local_registry: ccode_hub_sdk::LocalRegistry::new(),
    ...
    pub fn local_registry(&self) -> &ccode_hub_sdk::LocalRegistry {
        &self.local_registry
    }
    ...
    /// `ccode.dev/*` tool `_meta` contract (tool normalization). Returns `None` for
    ...
    fn tool_not_found_error(tool_name: &str) -> ccode_tool_runtime::ToolError {
        let tid = ccode_tool_protocol::ToolId::new(tool_name)
            .unwrap_or_else(|_| ccode_tool_protocol::ToolId::new("unknown").expect("valid"));
        ccode_tool_runtime::ToolError::not_found(tid, format!("Tool not found: {tool_name}"))
    }
    pub async fn try_parse(
        &self,
        tool_name: &str,
        tool_params: &serde_json::Value,
    ) -> Result<ToolInput, ccode_tool_runtime::ToolError> {
    ...
    async fn call_raw(
        ...
        parent_ctx: ccode_tool_runtime::ToolCallContext,
    ) -> Result<crate::types::output::ToolOutput, ccode_tool_runtime::ToolError> {
        ...
        let mut ctx = ccode_tool_runtime::ToolCallContext::new(parent_ctx.call_id.clone());
        ctx.extensions.insert(self.resources.clone());
        ctx.extensions.insert_arc(Arc::clone(&self.renderer));
        if let Some(cancellation) = parent_ctx.get::<ccode_tool_runtime::Cancellation>() {
        ...
        if let Some(cwd) = parent_ctx.extensions.get::<ccode_tool_runtime::Cwd>() {
            ctx.extensions.insert((*cwd).clone());
        }
        let tool_id = ccode_tool_protocol::ToolId::new(&registry_id)
            .unwrap_or_else(|_| ccode_tool_protocol::ToolId::new("unknown").expect("valid"));
        let lr_handle = self.local_registry.find(&tool_id).ok_or_else(|| {
            ccode_tool_runtime::ToolError::not_found(
                tool_id,
        ...
        (output_converter)(value)
            .map_err(|e| ccode_tool_runtime::ToolError::custom("output_decoding", e.to_string()))
    }
    ...
    pub async fn call_with_cancellation(
        ...
        while let Some(item) = stream.next().await {
            match item {
                ccode_tool_runtime::ToolStreamItem::Progress(_) => continue,
                ccode_tool_runtime::ToolStreamItem::Terminal(result) => return result,
            }
        }
        Err(stream_no_terminal_error())
    }
    ...
    ///
    /// [`ToolStream`]: ccode_tool_runtime::ToolStream
    /// [`ToolStreamItem::Progress`]: ccode_tool_runtime::ToolStreamItem::Progress
    pub fn call_streaming(
        ...
        tool_call_id: &str,
        cwd_override: Option<std::path::PathBuf>,
    ) -> ccode_tool_runtime::ToolStream<ToolRunResult> {
    ...
    pub fn call_streaming_with_cancellation(
        ...
        Box::pin(async_stream::stream! {
            let parts = match this.prepare_dispatch(
                ...
                Ok(parts) => parts,
                Err(e) => {
                    yield ccode_tool_runtime::ToolStreamItem::Terminal(Err(e));
                    return;
                }
            };
            let DispatchParts {
            ...
            while let Some(item) = inner.next().await {
                match item {
                    ccode_tool_runtime::ToolStreamItem::Progress(p) => {
                        yield ccode_tool_runtime::ToolStreamItem::Progress(p);
                    }
                    ccode_tool_runtime::ToolStreamItem::Terminal(Err(e)) => {
                        yield ccode_tool_runtime::ToolStreamItem::Terminal(Err(e));
                        return;
                    }
                    ccode_tool_runtime::ToolStreamItem::Terminal(Ok(typed)) => {
                        let run_result = this
                            .finalize_output(typed.value, &output_converter, effective_tool_name)
                            .await;
                        yield ccode_tool_runtime::ToolStreamItem::Terminal(run_result);
                        return;
                    }
                }
            }
            yield ccode_tool_runtime::ToolStreamItem::Terminal(Err(stream_no_terminal_error()));
        })
    }
    ...
    fn prepare_dispatch(
        ...
        cwd_override: Option<std::path::PathBuf>,
        cancellation: Option<tokio_util::sync::CancellationToken>,
    ) -> Result<DispatchParts, ccode_tool_runtime::ToolError> {
        let (registry_id, output_converter, reverse_params) = {
            let tools = self.tools.read();
            let entry = tools
                .iter()
        ...
        let rt_call_id = ccode_tool_protocol::ToolCallId::new(tool_call_id)
            .unwrap_or_else(|_| ccode_tool_protocol::ToolCallId::new_v7());
        let mut ctx = ccode_tool_runtime::ToolCallContext::new(rt_call_id);
        ctx.extensions.insert(self.resources.clone());
        ctx.extensions.insert_arc(Arc::clone(&self.renderer));
        ctx.extensions.insert(
            crate::types::resources::InvokingToolParamNames::from_reverse_params(&reverse_params),
        ...
        if let Some(cwd) = cwd_override {
            ctx.extensions.insert(ccode_tool_runtime::Cwd(cwd));
        }
        if let Some(cancellation) = cancellation {
            ctx.extensions
                .insert(ccode_tool_runtime::Cancellation(cancellation));
        }
        if let Some(ref version) = contract_version {
            ctx.extensions
                .insert(ccode_tool_runtime::BehaviorVersion(version.clone()));
        }
    ...
    ///
    /// The tool must implement `ccode_tool_runtime::Tool + ToolMetadata`.
    ...
    ) -> Result<(), ccode_tool_runtime::ToolError>
    where
        T: ccode_tool_runtime::Tool + ToolMetadata + std::fmt::Debug + Send + Sync + 'static,
        T::Output: serde::Serialize,
    {
        let mut tools = self.tools.write();
        if tools.iter().any(|t| t.client_name == name) {
            return Err(ccode_tool_runtime::ToolError::invalid_arguments(format!(
                "Tool already registered: {name}"
            )));
        }
        let description = tool.description_template().to_string();
        let kind = tool.kind();
        let registry_id = ccode_tool_runtime::Tool::id(&tool).as_str().to_owned();
    ...
    pub fn unregister_tools_by_prefix(&self, prefix: &str) -> usize {
        ...
        let to_remove: Vec<_> = tools
            ...
            .filter_map(|t| ccode_tool_protocol::ToolId::new(&t.registry_id).ok())
            .collect();
    ...
    pub fn unregister_tool_by_name(&self, name: &str) -> bool {
        ...
        let tool_id = tools
            ...
            .and_then(|t| ccode_tool_protocol::ToolId::new(&t.registry_id).ok());
        let before = tools.len();
...
fn explain_requirement_failure(
    ...
    match fq_tool_id.as_str() {
        ...
        "CcodeBuild:get_task_output" => {
            let has_ccode_build_bash = has_tool_with_bool_param(
                proposed,
                "CcodeBuild",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_ccode_build_concise_bash = has_tool_with_bool_param(
                proposed,
                "CcodeBuildConcise",
                "run_terminal_cmd",
                "enabled_background",
            ...
            let has_task = has_tool(proposed, "CcodeBuild", "task");
            let mut notes = vec![];
            if has_tool(proposed, "CcodeBuild", "run_terminal_cmd")
                && !has_ccode_build_bash
            {
                notes
                    .push(
                        "CcodeBuild:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            if has_tool(proposed, "CcodeBuildConcise", "run_terminal_cmd")
                && !has_ccode_build_concise_bash
            {
                notes
                    .push(
                        "CcodeBuildConcise:run_terminal_cmd is present but enabled_background=false",
                    );
            }
            let mut message = "get_task_output requires a background-capable bash tool (CcodeBuild:run_terminal_cmd or CcodeBuildConcise:run_terminal_cmd with enabled_background=true), OpenCode:bash, or CcodeBuild:task"
                .to_string();
            let has_provider = has_ccode_build_bash || has_ccode_build_concise_bash
            ...
            RequirementError::new(fq_tool_id, message)
                .with_field_path("tools")
                .with_expected(
                    "include a background-capable bash tool, OpenCode:bash, or CcodeBuild:task",
                )
                .with_category("requirements")
        }
        "CcodeBuild:search_replace" if !params
            ...
            RequirementError::new(
                ...
                .with_expected(
                    "set skip_read_before_edit=true or include a Read tool such as CcodeBuild:read_file",
                )
                .with_bad_value(serde_json::Value::Bool(false))
                .with_category("requirements")
        }
        "CcodeBuild:enter_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "enter_plan_mode requires CcodeBuild:exit_plan_mode so plan mode can always be exited",
                )
                .with_field_path("tools")
                .with_expected("include CcodeBuild:exit_plan_mode")
                .with_category("requirements")
        }
        "CcodeBuild:exit_plan_mode" => {
            RequirementError::new(
                    fq_tool_id,
                    "exit_plan_mode requires CcodeBuild:enter_plan_mode so plan mode can be entered before exiting",
                )
                .with_field_path("tools")
                .with_expected("include CcodeBuild:enter_plan_mode")
                .with_category("requirements")
        }
        _ => {
...
mod tests {
    ...
    fn test_session_context(tmp: &TempDir) -> SessionContext {
        SessionContext {
            ...
            web_fetch_config:
                crate::implementations::ccode_build::web_fetch::WebFetchConfig::default(),
            lsp: None,
            image_gen_config:
                crate::implementations::ccode_build::image_gen::ImageGenConfig::default(),
            video_gen_config:
                crate::implementations::ccode_build::video_gen::VideoGenConfig::default(),
            app_builder_deployer_config:
                crate::implementations::ccode_build::deploy_app::AppBuilderDeployerConfig::default(),
    ...
    /// appeared before `ccode_build:search_replace` (`ToolKind::Edit`, input:
    ...
    async fn kind_params_merged_across_multiple_tools_of_same_kind() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "CcodeBuild:search_replace".to_string(),
                    params: Some(
    ...
    async fn search_replace_description_renders_minimum_anchor_guidance() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "CcodeBuild:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// Smoke test: finalize the full CcodeBuild toolset and verify every
    ...
    async fn full_toolset_descriptions_render_cleanly() {
        use crate::implementations::ccode_build::{
        ...
        let config = ToolServerConfig {
            ...
            .into_iter()
            .map(|id| ToolConfig::from_id(format!("CcodeBuild:{id}")))
    ...
    /// name: `run_terminal_cmd` (ccode).
    #[tokio::test]
    async fn tool_name_for_kind_resolves_execute() {
        use crate::types::tool::ToolKind;
        let tmp = TempDir::new().unwrap();
        let ccode = ToolRegistryBuilder::new()
            .finalize(
                ToolServerConfig {
                    tools: vec![
                        ToolConfig::from_id("CcodeBuild:run_terminal_cmd".to_string()),
                        ToolConfig::from_id("CcodeBuild:get_task_output".to_string()),
                        ToolConfig::from_id("CcodeBuild:kill_task".to_string()),
                    ],
                    behavior_preset: None,
                },
                test_session_context(&tmp),
            )
            .expect("ccode toolset should finalize");
        assert_eq!(
            ccode.tool_name_for_kind(ToolKind::Execute).as_deref(),
            Some("run_terminal_cmd")
        );
    }
    /// `merge_tool_meta` (the harness emission path) must stamp `ccode.dev/tool` for a
    ...
    fn tool_config_kind_sinks_unknown_to_other() {
        ...
        let known = parse(serde_json::json!({"id": "CcodeBuild:read_file", "kind": "read"}));
        assert_eq!(known.kind, Some(ToolKind::Read));
        let typo = parse(serde_json::json!({"id": "CcodeBuild:read_file", "kind": "raed"}));
        assert_eq!(typo.kind, Some(ToolKind::Other));
        let absent = parse(serde_json::json!({"id": "CcodeBuild:read_file"}));
    ...
    /// Verify CcodeBuildConcise tools can be finalized and produce concise output.
    #[tokio::test]
    async fn test_concise_namespace_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "CcodeBuildConcise:read_file".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "CcodeBuildConcise:search_replace".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
                ...
                ToolConfig {
                    id: "CcodeBuildConcise:run_terminal_cmd".to_string(),
                    params: Some(
                ...
                ToolConfig::for_tool::<ccode_build::GrepTool>(),
                ToolConfig::for_tool::<ccode_build::KillTaskTool>(),
                ToolConfig::for_tool::<ccode_build::TaskOutputTool>(),
                ToolConfig {
                    id: "CcodeBuild:list_dir".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    fn has_tool_id_knows_pinned_tool_config_ids() {
        let builder = ToolRegistryBuilder::new();
        for id in [
            "CcodeBuild:run_terminal_cmd",
            "CcodeBuild:read_file",
            "CcodeBuild:search_replace",
            "CcodeBuild:list_dir",
            "CcodeBuild:grep",
            "CcodeBuild:get_terminal_command_output",
            "CcodeBuild:kill_terminal_command",
        ] {
            assert!(
        ...
        assert!(
            !builder.has_tool_id("CcodeBuild:does_not_exist"),
    ...
    fn known_tool_kinds_maps_pinned_tool_config_ids() {
        ...
        for (id, expected) in [
            ("CcodeBuild:run_terminal_cmd", ToolKind::Execute),
            ("CcodeBuild:read_file", ToolKind::Read),
            ("CcodeBuild:search_replace", ToolKind::Edit),
            ("CcodeBuild:grep", ToolKind::Search),
            ("CcodeBuild:list_dir", ToolKind::List),
        ] {
            assert_eq!(
                kinds.get(id),
                Some(&expected),
        ...
        assert!(
            !kinds.contains_key("CcodeBuild:does_not_exist"),
    ...
    /// (e.g. `"read_file"`). If both `CcodeBuild:read_file` and
    ...
    fn validate_config_reports_param_field_path_and_value() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "CcodeBuild:run_terminal_cmd".to_string(),
                params: Some(
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "CcodeBuild:run_terminal_cmd");
        assert_eq!(
    ...
    fn validate_config_reports_semantic_hashline_param_error() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "CcodeBuildHashline:hashline_read".to_string(),
                params: Some(
                    serde_json::from_value(serde_json::json!({
                        "hash_len": 0
                    }))
    ...
    impl ccode_tool_runtime::Tool for FakeMcpTool {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> ccode_tool_protocol::ToolId {
            ccode_tool_protocol::ToolId::new("fake_mcp").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::ccode_tool_runtime::ListToolsContext,
        ) -> ccode_tool_types::ToolDescription {
            ccode_tool_types::ToolDescription::new("fake_mcp", &self.description)
        }
        async fn run(
            &self,
            _ctx: ccode_tool_runtime::ToolCallContext,
            _input: serde_json::Value,
        ) -> Result<String, ccode_tool_runtime::ToolError> {
            Ok("ok".into())
        }
    }
    #[tokio::test]
    ...
    impl ccode_tool_runtime::Tool for NonStreamingStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> ccode_tool_protocol::ToolId {
            ccode_tool_protocol::ToolId::new("non_streaming_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::ccode_tool_runtime::ListToolsContext,
        ) -> ccode_tool_types::ToolDescription {
            ccode_tool_types::ToolDescription::new("non_streaming_stub", "non-streaming stub")
        }
        async fn run(
            &self,
            _ctx: ccode_tool_runtime::ToolCallContext,
    ...
    impl ccode_tool_runtime::Tool for StreamingStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> ccode_tool_protocol::ToolId {
            ccode_tool_protocol::ToolId::new("streaming_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::ccode_tool_runtime::ListToolsContext,
        ) -> ccode_tool_types::ToolDescription {
            ccode_tool_types::ToolDescription::new("streaming_stub", "streaming stub")
        }
        async fn run(
            &self,
            _ctx: ccode_tool_runtime::ToolCallContext,
        ...
        async fn execute(
            ...
            _ctx: ccode_tool_runtime::ToolCallContext,
            _input: serde_json::Value,
        ) -> ccode_tool_runtime::ToolStream<String> {
            Box::pin(futures::stream::iter(vec![
                ccode_tool_runtime::ToolStreamItem::Progress(ccode_tool_runtime::ToolProgress::Text {
                    text: "progress-1".into(),
                }),
                ccode_tool_runtime::ToolStreamItem::Terminal(Ok("terminal-value".to_string())),
            ]))
        }
    }
    ...
    async fn call_non_streaming_stub_back_compat() {
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<ccode_build::ReadFileTool>()],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
        let toolset = Arc::new(builder.finalize(config, ctx).unwrap());
        ...
        while let Some(item) = stream.next().await {
            match item {
                ccode_tool_runtime::ToolStreamItem::Progress(p) => {
                    ...
                    assert!(matches!(p, ccode_tool_runtime::ToolProgress::Text { .. }));
                    progress_count += 1;
                }
                ccode_tool_runtime::ToolStreamItem::Terminal(result) => {
    ...
    impl ccode_tool_runtime::Tool for NoTerminalStub {
        type Args = serde_json::Value;
        type Output = String;
        fn id(&self) -> ccode_tool_protocol::ToolId {
            ccode_tool_protocol::ToolId::new("no_terminal_stub").expect("valid")
        }
        fn description(
            &self,
            _ctx: &::ccode_tool_runtime::ListToolsContext,
        ) -> ccode_tool_types::ToolDescription {
            ccode_tool_types::ToolDescription::new("no_terminal_stub", "no-terminal stub")
        }
        async fn run(
            &self,
            _ctx: ccode_tool_runtime::ToolCallContext,
    ...
    async fn tool_definitions_builtins_only_hides_mcp_tools() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<ccode_build::ReadFileTool>(),
                ToolConfig::for_tool::<ccode_build::GrepTool>(),
            ],
            behavior_preset: None,
        };
    ...
    fn task_tool_rejected_without_get_task_output_and_kill_task() {
        ...
        assert!(
            errors.iter().any(|e| e.tool == "CcodeBuild:task"
                && e.message.contains("CcodeBuild:get_task_output")
                && e.message.contains("CcodeBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_get_task_output() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "CcodeBuild:get_task_output".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        assert!(
            errors
                .iter()
                .any(|e| e.tool == "CcodeBuild:task" && e.message.contains("CcodeBuild:kill_task")),
    ...
    fn task_tool_rejected_with_only_kill_task() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "CcodeBuild:kill_task".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
    ...
    /// ccode-build agent config (all tools present) and that the new examples
    ...
    async fn background_param_templates_reference_real_schema_keys() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                tool("CcodeBuild:run_terminal_cmd"),
                tool("CcodeBuild:task"),
                tool("CcodeBuild:get_task_output"),
                tool("CcodeBuild:wait_tasks"),
                tool("CcodeBuild:kill_task"),
            ],
            behavior_preset: None,
        };
        let tmp = TempDir::new().unwrap();
    ...
    fn bash_with_enabled_background_reports_missing_task_tools() {
        ...
        assert!(error.message.contains("CcodeBuild:get_task_output"));
        assert!(error.message.contains("CcodeBuild:kill_task"));
        assert!(
            error
                .expected
                .as_deref()
    ...
    fn task_requirement_error_lists_missing_background_tools() {
        ...
        let error = &errors[0];
        assert_eq!(error.tool, "CcodeBuild:task");
        assert!(error.message.contains("CcodeBuild:get_task_output"));
        assert!(error.message.contains("CcodeBuild:kill_task"));
    ...
    fn search_replace_requirement_error_mentions_read_tool() {
        ...
        let error = errors
            .iter()
            .find(|error| error.tool == "CcodeBuild:search_replace")
    ...
    fn ask_user_question_validates_standalone() {
        ...
        let config = ToolServerConfig {
            tools: vec![ToolConfig {
                id: "CcodeBuild:ask_user_question".to_string(),
                params: None,
                name_override: None,
                params_name_overrides: None,
                description_override: None,
    ...
    async fn task_description_renders_with_default_agent_config() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ...
                ToolConfig {
                    id: "CcodeBuild:web_search".to_string(),
                    params: None,
                    name_override: None,
                    params_name_overrides: None,
                    description_override: None,
        ...
        let toolset = builder
            .finalize(config, ctx)
            .expect("finalize should succeed with default ccode-build tools");
        let defs = toolset.tool_definitions();
        let task_def = defs
            .iter()
    ...
    fn hashline_tools_registered_in_builder() {
        ...
        assert!(
            builder
                .tools
                .contains_key("CcodeBuildHashline:hashline_read"),
            "hashline_read should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("CcodeBuildHashline:hashline_edit"),
            "hashline_edit should be registered"
        );
        assert!(
            builder
                .tools
                .contains_key("CcodeBuildHashline:hashline_grep"),
    ...
    async fn hashline_config_finalizes_successfully() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("CcodeBuildHashline:hashline_read"),
                hashline_tool_config("CcodeBuildHashline:hashline_edit"),
                hashline_tool_config("CcodeBuildHashline:hashline_grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn standard_and_hashline_each_finalize_independently() {
        ...
        let standard_config = ToolServerConfig {
            tools: vec![
                hashline_tool_config("CcodeBuild:read_file"),
                hashline_tool_config("CcodeBuild:search_replace"),
                hashline_tool_config("CcodeBuild:grep"),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn empty_struct_schema_has_properties_and_required() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<ccode_build::EnterPlanModeTool>(),
                ToolConfig::for_tool::<ccode_build::ExitPlanModeTool>(),
            ],
            behavior_preset: None,
        };
        let ctx = test_session_context(&tmp);
    ...
    async fn hashline_toolset_e2e_with_utilities() {
        ...
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig {
                    id: "CcodeBuildHashline:hashline_read".to_owned(),
                    params: Some(
                ...
                ToolConfig::for_tool::<ccode_build_hashline::HashlineEditTool>(),
                ToolConfig::for_tool::<ccode_build_hashline::HashlineGrepTool>(),
                ToolConfig::for_tool::<ccode_build::ListDirTool>(),
            ],
            behavior_preset: None,
        };
        let errors = builder.validate_config(&config);
    ...
    fn bash_config_with_background() -> ToolConfig {
        ToolConfig {
            id: "CcodeBuild:run_terminal_cmd".to_owned(),
            params: Some(
                serde_json::json!({ "enabled_background": true })
                    .as_object()
                    .unwrap()
    ...
    async fn ccode_build_bridge(tmp: &TempDir) -> crate::bridge::ToolBridge {
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![
                ToolConfig::for_tool::<ccode_build::ListDirTool>(),
                ToolConfig::for_tool::<ccode_build::ReadFileTool>(),
                ToolConfig::for_tool::<ccode_build::SearchReplaceTool>(),
                bash_config_with_background(),
                ToolConfig::for_tool::<ccode_build::TaskOutputTool>(),
                ToolConfig::for_tool::<ccode_build::KillTaskTool>(),
                ToolConfig::for_tool::<ccode_build::GrepTool>(),
                ToolConfig::for_tool::<ccode_build::TodoWriteTool>(),
            ],
            behavior_preset: None,
        };
    ...
    async fn hub_dispatch_list_dir() {
        ...
        let bridge = ccode_build_bridge(&tmp).await;
        let result = bridge
            .call(
                "list_dir",
    ...
    async fn hub_dispatch_parity_list_dir() {
        ...
        let hub_bridge = ccode_build_bridge(&tmp).await;
        ...
        let builder = ToolRegistryBuilder::new();
        let config = ToolServerConfig {
            tools: vec![ToolConfig::for_tool::<ccode_build::ListDirTool>()],
            behavior_preset: None,
        };
    ...
    fn generate_schema_strips_root_title_and_description() {
        let schema = generate_schema::<crate::implementations::ccode_build::bash::BashToolInput>();
        assert!(
    ...
    async fn prepare_dispatch_stamps_workspace_viewer_ctx_when_present() {
        let (toolset, _tmp) =
            toolset_with_viewer_ctx(Some(ccode_tool_runtime::WorkspaceViewerContext {
        ...
        let wvc = parts
            .ctx
            .extensions
            .get::<ccode_tool_runtime::WorkspaceViewerContext>()
    ...
    async fn bash_streaming_progress_emitted_via_finalized_toolset_when_gate_on() {
        ...
        while let Some(item) = stream.next().await {
            match item {
                ccode_tool_runtime::ToolStreamItem::Progress(_) => progress_count += 1,
                ccode_tool_runtime::ToolStreamItem::Terminal(r) => {
