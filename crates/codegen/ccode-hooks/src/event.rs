...
pub struct StopSessionCron {
    pub id: String,
    /// Human-readable interval (e.g. `every 5 minutes`): ccode schedules are intervals, not cron.
    pub schedule: String,
    pub recurring: bool,
    pub prompt: String,
}
...
/// `StopFailure` error type. Ccode emits a subset: capacity errors fold into
