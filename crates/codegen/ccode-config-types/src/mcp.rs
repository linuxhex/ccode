//! MCP server configuration value types, extracted from ccode-shell
...
use ccode_mcp::oauth_config::McpOAuthConfig;
...
impl RelaySyncConfig {
    ...
    pub fn is_enabled(&self) -> bool {
        if let Ok(env_val) = std::env::var("CCODE_RELAY_SYNC_ENABLED") {
