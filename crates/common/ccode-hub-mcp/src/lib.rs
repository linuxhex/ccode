//! Unified MCP adapter for the Ccode Hub.
//!
...
//! tools, and produces [`ToolServerHandler`](ccode_hub_sdk::ToolServerHandler)
//! implementations that can be registered with a hub
//! [`ToolServerBuilder`](ccode_hub_sdk::ToolServerBuilder).
//!
//! # Architecture
//!
//! ```text
