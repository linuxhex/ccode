...
pub struct ToolCallResult {
    ...
    /// this crate must not depend on `ccode-tool-runtime`. Sampler-side wire
...
/// `ccode_hub_core::registry::ToolSessionBindOutcome`, with one
...
pub struct ToolsListResult {
    pub tools: Vec<ccode_tool_types::ToolDescription>,
}
