...
/// `filename`, `path`, `metadata`) that the Ccode SLOP converter uses to
...
pub enum ContentBlock {
    ...
    ///
    /// Optional metadata fields are used by the Ccode SLOP converter to
    ...
    /// - `path`: file path on the Ccode Computer filesystem
