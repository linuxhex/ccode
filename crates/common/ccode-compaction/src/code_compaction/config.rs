//! ccode-build compaction configuration.
//!
...
/// ccode-build and Ccode chat (~85% trigger on both sides).
pub const DEFAULT_AUTO_COMPACT_THRESHOLD_PERCENT: u8 = 85;

/// Minimum character count for a cleaned summary seed.
///
/// ccode-build retries when the cleaned summary is shorter than this — the
