...
//! string/text manipulation. Harness-bound extraction (Ccode chat's
//! `CcodeConversation` traversal, `ChatCompletionRequest` user-message
//! extraction, `CcodeMessage` assembly) stays in the harness crate.
