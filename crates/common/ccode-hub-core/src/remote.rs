...
fn map_block(block: ccode_tool_protocol::McpBlock) -> ContentBlock {
    use ccode_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: ccode_tool_protocol::JsonRpcError) -> ToolError {
