...
/// Numeric JSON-RPC code for overload rejection (`ccode-tool-protocol`
...
const GLOBAL_MAX_INFLIGHT_ENV: &str = "CCODE_TOOL_SERVER_GLOBAL_MAX_INFLIGHT";
...
/// `CCODE_TOOL_SERVER_GLOBAL_MAX_INFLIGHT` when present and parseable as a
